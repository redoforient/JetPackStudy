...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        numberMin = findViewById(R.id.bt_number_min);
        numberCall = findViewById(R.id.iv_number_call);

        numberBackspace = findViewById(R.id.bt_number_backspace);
